<template lang="html">
    <div>
        <TitleServicesVue title1="Pulido de Faros" title2="Deja tu parabrisas en manos de profesionales certificados" :img="require('@/assets/faros.jpg')"></TitleServicesVue>
        ...
        <BeneficiosServiceVue :items="beneficios" :img="require('@/assets/beneficios2.jpg')"></BeneficiosServiceVue>
    </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      beneficios: ["Eliminar los arañazos."
